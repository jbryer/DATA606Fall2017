...
* You need to focus on three variables, `x`, `y`, and `z` so you can run a regression of this form: `y ~ x + z`.
...
* For descriptive statistics, use the appropriate function.
	* Qualitative variables: `table` and `prop.table`.
	* Quantitative variables: `psych::describe` works best. `summary` is good but does not include the standard deviation.
	* Quantitative and Qualitative variables: `psych::describeBy`


## Presentations

* Jun Yan (7.25) http://rpubs.com/azureblue83/326772
* Eric Pitruzzella (7.29)
* Albina Gallyavova (7.30) http://rpubs.com/agallyavova/327787
