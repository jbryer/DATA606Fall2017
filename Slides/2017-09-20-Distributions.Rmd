...
```{r pollresults}
poll <- read.csv('DATA606-Poll-Results.csv', stringsAsFactors = FALSE)
ggplot(poll, aes(x = Q1)) + geom_bar() + 
	ggtitle('Which of the following would be your preferred platform to communicate with students?')
```
...
```{r q2}
ggplot(poll, aes(x = Q2)) + geom_bar() + 
	ggtitle('Is the Github Issues feature useful for asking course related questions?')
```

## Meetup Presentations

* Kai Lukowiak (3.4)
* Mike D'Acampora (3.18)
* Mehdi Khan (3.37)
